...
var scoreJoueurB=0;
  do {
    ...
    if (joueurA > joueurB && scoreJoueurA==15) {
      scoreJoueurA += 15;
      console.log("score de A : " + scoreJoueurA + ", score de B : "  + scoreJoueurB );
    } else if (joueurB > joueurA && scoreJoueurB==15) {
      scoreJoueurB += 15;
      console.log("score de A : " + scoreJoueurA + ", score de B : "  + scoreJoueurB );
    } else if (joueurA > joueurB && scoreJoueurA==0) {
      scoreJoueurA += 15;
      console.log("score de A : " + scoreJoueurA + ", score de B : "  + scoreJoueurB );
    } else if (joueurB > joueurA && scoreJoueurB==0) {
      scoreJoueurB += 15;
      console.log("score de A : " + scoreJoueurA + " , score de B : "  + scoreJoueurB );
    ...
    } else if (joueurA > joueurB && scoreJoueurA==40) {
      console.log("score de A : " + scoreJoueurA +  " , score de B : " + scoreJoueurB );
      break;
    } else if (joueurB > joueurA && scoreJoueurB==40) {
      console.log("score de A : " + scoreJoueurA +  " , score de B : " + scoreJoueurB);
      break;
    }
